...
namespace ReviewSite.Migrations
{
    ...
    [Migration("20181030154749_AddedMoreSeedData")]
            ...
            modelBuilder.Entity("ReviewSite.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 4, CategoryId = 1, Content = "It's very easy to mistake Untoasted Corgis as loafs of bread, but if you look closely you can see that it's just a corgi, no worries.", ImageUrl = "/Images/corgiLoaf.jpg", Title = "Corgi Type: Loaf" },
                        ...
                        new { Id = 7, CategoryId = 3, Content = "Need a ride? Call on Cowboy Corgi to get you from point A to point B in record time!", ImageUrl = "/Images/codingCorgi.jpg", Title = "Corgi Type: Cowboy Corgi" },
